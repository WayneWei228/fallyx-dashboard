  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/the-wellington-ltc" element={<Dashboard title={'The Wellington LTC Falls Dashboard'} />}></Route>
        <Route path="/iggh-ltc" element={<Dashboard title={'Ina Grafton Gage Home Falls Dashboard'} />}></Route>
        <Route path="/mill-creek-care" element={<Dashboard title={'Mill Creek Care Center Falls Dashboard'} />}></Route>
