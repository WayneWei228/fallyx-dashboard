...
export default function Dashboard(props) {
    ...
    useEffect(() => {
        ...
        setChart(new Chart(document.getElementById("gaugeChart"), {
            type: 'doughnut',
            data: {
                datasets: [{
                    data: [7, 13],
        ...
        setAnalysisChart(new Chart(document.getElementById('fallsAnalysisChart').getContext('2d'), {
            type: 'bar',
            data: {
    ...
    const updateFalls = () => {
        ...
        do { newGoal = parseInt(prompt("Please enter the new Falls Goal"), 10); } while (isNaN(newGoal))

        const goalRef = ref(db);
        const updates = {'falls_goal/': newGoal};
        update(goalRef, updates).then(() => {
    ...
    return (
        <div className="dashboard">
            ...
            <div className="chart-container">
                <div className="chart">
                    <div className="gauge-container">
                        <h2 style={{paddingTop: "7.5px"}} id="Header">Falls Overview</h2>
                        ...
                        <div id="gaugeContainer">
                            <div className="gauge">
                                ...
                                <div className="gauge-goal">Goal: <span id="fallGoal">{goal}</span></div>
                                <br /> 
                        ...
                        {gaugeChart ?
                        <div>
                        <button className="update-button" id="update-button" onClick={updateFalls}>Update Falls Goal</button>
                        </div>
                        :
                        <></>
                        }
            ...
            <div className="table-header">
                ...
                <button className="download-button" onClick={downloadTable}>Download as Excel</button>
            </div>
            <table id="fallsTable">
                <thead>
                    <tr>
